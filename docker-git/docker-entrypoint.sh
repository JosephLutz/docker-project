...
# backup         : archives the git repositories into the IMPORT_EXPORT_PATH
# restore        : restore repository archive names (*.backup.tar.gz | *.mirror.tar.gz) from the remining arguments
