...
# variables for GIT
GIT_IP=172.16.0.102
HOST_SVN_DIR=$(pwd)/data/git_git
HOST_GIT_SSL_DIR=$(pwd)/data/git_ssl
HOST_GIT_PASSWD_DIR=$(pwd)/data/git_password
GIT_REPOS=("")


HTPASSMAN_IP=172.16.0.103
